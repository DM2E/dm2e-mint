...
public class MappingDetailsBeanFactory {
	...
	public MappingDetailsBeanFactory(String organizationId, Date startDate, Date endDate) {
		super();
	...
	List<MappingDetailsBean> mappings = new  ArrayList<MappingDetailsBean>();
		...
		MappingDetailsBean mappingDetailsBean = new MappingDetailsBean(name, created, lastModified, organizationId, organizationName, schemaName, schemaId);
