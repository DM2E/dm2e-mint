...
//	private java.util.List<java.util.Map.Entry<String,Integer>> pairList ;//= new java.util.ArrayList<>();
	...
	public Integer getOaipublisheditems() {
		return oaiuniqueitems;
	}
	public void setOaipublisheditems(Integer oaipublisheditems) {
		this.oaiuniqueitems = oaipublisheditems;
	}
	
	public OrganizationStatisticsBean(String name, String country,
			Integer uploadedItems, Integer transformedItems,
			Integer publishedItems, Integer numberofmappings,
			Integer numberofuploads, Integer numberoftransformations,
			Integer numberofpublications, Integer oaiuniqueitems) {
		super();
		this.name = name;
		this.country = country;
		this.uploadedItems = uploadedItems;
