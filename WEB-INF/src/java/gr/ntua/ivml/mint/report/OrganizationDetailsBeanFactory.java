...
public class OrganizationDetailsBeanFactory {
	...
	public OrganizationDetailsBeanFactory(String id,Date startdate,Date enddate ) {
		super();
		...
		this.mappingDetailsBeanFactory = new MappingDetailsBeanFactory(id,startDate,endDate);
		this.oaipublicationbeanFactory = new OaiPublicationDetailsBeanFactory(id,startDate,endDate);
		this.datauploadDetailsFactory = new DataUploadDetailsBeanFactory(organizationId,startDate,endDate);
	}
	...
	public List<OrganizationDetailsBean> getOrgDetailsBeans(JSONObject jsonObject){
		...
		OrganizationDetailsBean organizationdetailsbean = new OrganizationDetailsBean(name, country, uploadsbeanCollection, mappingsbeanCollection, transformationsbeanCollection, publicationsbeanCollection,oaipublicationbeanCollection);
