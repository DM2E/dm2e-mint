...
public class PublicationDetailsBeanFactory {
	...
	public List<PublicationDetailsBean> getPublications(){			
		...
		while (it.hasNext()){
			...
			PublicationDetailsBeanFactory lala = new PublicationDetailsBeanFactory(organizationId, startDate, endDate);
	...
	List<PublicationDetailsBean> publications = new ArrayList<PublicationDetailsBean>();
		...
		while (it.hasNext()){
			...
			if (publishedItems==-1) publishedItems = 0;
		...
		PublicationDetailsBean publicationDetailsBean = new PublicationDetailsBean(name, created, lastModified, creatorId, creatorName, itemCount,publishedItems, itemizerStatus, organizationId, organizationName);
