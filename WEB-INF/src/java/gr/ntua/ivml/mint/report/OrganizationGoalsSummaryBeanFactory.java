...
public class OrganizationGoalsSummaryBeanFactory {
	...
	public OrganizationGoalsSummaryBeanFactory(String id,Date startdate,Date enddate ) {
		super();
	...
	public List<OrganizationGoalsSummaryBean> getOrgGoalBeans(){		
		...
		while (it.hasNext()){
			...
			OrganizationGoalsSummaryBeanFactory factory = new OrganizationGoalsSummaryBeanFactory(organizationId, startDate, endDate);
			List<OrganizationGoalsSummaryBean> progbeans = new ArrayList<OrganizationGoalsSummaryBean>();
			progbeans = factory.getOrgGoalBeans(organizationId);
	...
	public List<OrganizationGoalsSummaryBean> getOrgGoalBeans(JSONObject jsonObject) {
		...
		Integer totalTransformedValidItems = transformationDetailsBeanFactory.gettotalValidItemsTransformed();
		Integer totalPublishedValidItems = publicationDetailsBeanFactory.gettotalValidItemsPublished();
		Integer totalOaiPublishedValidItems = oaipublicationbeanFactory.gettotalValidItemsPublished();
	
		OrganizationGoalsSummaryBean transformedgoalbean  = new OrganizationGoalsSummaryBean("Transformed Valid Items", today, totalTransformedValidItems, name,organizationId,"transformed");
		goals.add(transformedgoalbean);

		OrganizationGoalsSummaryBean publishedgoalbean  = new OrganizationGoalsSummaryBean("Published Valid Items", today, totalPublishedValidItems, name,organizationId,"published");
		goals.add(publishedgoalbean);

		OrganizationGoalsSummaryBean oaipublishedgoalbean  = new OrganizationGoalsSummaryBean("OAI Published Valid Items", today, totalOaiPublishedValidItems, name,organizationId,"oaipublished");
		goals.add(oaipublishedgoalbean);
		
		OrganizationGoalsSummaryBean currentGoalbean = new OrganizationGoalsSummaryBean("Current Target Number of Items", targetDate, targetItems, name, organizationId,"current goal");
		goals.add(currentGoalbean);

		OrganizationGoalsSummaryBean finalGoalbean = new OrganizationGoalsSummaryBean("Final Target Number of Items", finalDate	,	 finaltargetItems, name, organizationId,"final goal");
	...
	//	Date today = new Date();
		...
		while (it.hasNext()){
			...
			OrganizationGoalsSummaryBean goalbean = (OrganizationGoalsSummaryBean) it.next();
	...
	OrganizationGoalsSummaryBean transformedgoalbean  = new OrganizationGoalsSummaryBean("Transformed Valid Items", today, projectTransformed, null,null,"transformed");
	result.add(transformedgoalbean);

	OrganizationGoalsSummaryBean publishedgoalbean  = new OrganizationGoalsSummaryBean("Published Valid Items", today, projectPublished, null,null,"published");
	result.add(publishedgoalbean);

	OrganizationGoalsSummaryBean oaipublishedgoalbean  = new OrganizationGoalsSummaryBean("OAI Published Valid Items", today, projectOaiPublished, null,null,"oaipublished");
	result.add(oaipublishedgoalbean);

	OrganizationGoalsSummaryBean currentGoalbean = new OrganizationGoalsSummaryBean("Current Target Number of Items", targetDate, currenttargetItems, null, null,"current goal");
	result.add(currentGoalbean);

	OrganizationGoalsSummaryBean finalGoalbean = new OrganizationGoalsSummaryBean("Final Target Number of Items", finalDate	,	 finaltargetItems, null, null,"final goal");
